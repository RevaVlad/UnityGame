...
//     version 1.7.0
//     from Assets/Scripts/SceneControls 1.inputactions
//
...
public partial class @SceneControls1: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @SceneControls1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""SceneControls 1"",
    ""maps"": [
        {
            ""name"": ""Control"",
    ...
    {
        private @SceneControls1 m_Wrapper;
        public ControlActions(@SceneControls1 wrapper) { m_Wrapper = wrapper; }
